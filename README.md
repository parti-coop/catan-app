...
./settings/resoures 아래 로컬 개발용 firebase google-services.json와 GoogleService-Info.plist를 다운받아 google-services.json.development.json와 GoogleService-Info.development.plist라는 이름으로 넣어 둡니다. https://support.google.com/firebase/answer/7015592 여기를 참조합니다.
